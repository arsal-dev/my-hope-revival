...
! function(j) {
                    ...
                    if (e = Mn._addCacheSuffix(e), y[e] ? l = y[e] : (l = {
                        ...
                        if (2 !== l.status)
                            if (3 !== l.status) {
                                ...
                                b(u), u.href = themepath + "skins/ui/oxide/"+filename
                            } else i();
                        else o()
                }
    ...
    function $w(e, t) {
        ...
        ! function(e, t, n, r) {
            var o = t.settings,
                i = o.theme;
            var sometemp = '<?=app_url()?>';
            if (K(i)) {
                if (!jw(i) && !qd.urls.hasOwnProperty(i)) {
                    var a = o.theme_url;
                    a ? qd.load(i, t.documentBaseURI.toAbsolute(a)) : qd.load(i, themepath+"themes/" + i + "/theme" + ".min" + ".js")
                        ...
                        if ((e = Mn.trim(e)) && !jd.urls[e])
                            if (jw(e)) {
                                ...
                                Mn.each(t, function(e) {
                                    var t = {
                                        prefix: themepath+"plugins/",
                                        resource: e,
                                        suffix: "/plugin" + ".min" + ".js"
                                    };
                                    console.log(e.prefix + e.resource + e.suffix);
